...
#source("Code/impulse_response_function/IRF_function.R")
#source("C:/Users/Julia/Dropbox/DynamicVAR/Code/impulse_response_function/irf parameter uncertainty/IRF_function_v7_exp_intercept.r")
